...
export const wireConfigs : WireConfig[] = [
  { name: 'Green_wire_top', sprite: 'Green_wire_top.png', item: 'Wires' },
  { name: 'Green_wire_corner', sprite: 'Green_wire_corner.png', item: 'Wires' },
  { name: 'Green_wire_cross', sprite: 'Green_wire_cross.png', item: 'Wires' },
  { name: 'Green_wire_T', sprite: 'Green_wire_T.png', item: 'Wires' },
  { name: 'Blue_wire_top', sprite: 'Blue_wire_top.png', item: 'Wires' },
  { name: 'Blue_wire_corner', sprite: 'Blue_wire_corner.png', item: 'Wires' },
  { name: 'Blue_wire_cross', sprite: 'Blue_wire_cross.png', item: 'Wires' },
  { name: 'Blue_wire_T', sprite: 'Blue_wire_T.png', item: 'Wires' },
  { name: 'Wire_tunnel', sprite: 'Wire_tunnel.webp', item: 'Wires' },
