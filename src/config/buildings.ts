...
export const wireConfigs : WireConfig[] = [
  { name: 'Green_wire_top', sprite: 'Green_wire_top.png', item: 'Green Wire' },
  { name: 'Green_wire_corner', sprite: 'Green_wire_corner.png', item: 'Green Wire' },
  { name: 'Green_wire_cross', sprite: 'Green_wire_cross.png', item: 'Green Wire' },
  { name: 'Green_wire_T', sprite: 'Green_wire_T.png', item: 'Green Wire' },
  { name: 'Blue_wire_top', sprite: 'Blue_wire_top.png', item: 'Blue Wire' },
  { name: 'Blue_wire_corner', sprite: 'Blue_wire_corner.png', item: 'Blue Wire' },
  { name: 'Blue_wire_cross', sprite: 'Blue_wire_cross.png', item: 'Blue Wire' },
  { name: 'Blue_wire_T', sprite: 'Blue_wire_T.png', item: 'Blue Wire' },
  { name: 'Wire_tunnel', sprite: 'Wire_tunnel.webp', item: 'Wire Tunnel' },
  { name: 'Constant', sprite: 'Constant.png', item: 'Constant Signal' },
  // FIX: Make sure which item "Analyzer" and "Comparator" should be
  { name: 'Analyzer', sprite: 'Analyzer.webp', item: 'Logic Gate' },
  { name: 'Comparator', sprite: 'Comparator.webp', item: 'Logic Gate' },
  { name: 'Logic_gate-and', sprite: 'Logic_gate-and.webp', item: 'Logic Gate' },
  { name: 'Logic_gate-not', sprite: 'Logic_gate-not.webp', item: 'Logic Gate' },
  { name: 'Logic_gate-or', sprite: 'Logic_gate-or.webp', item: 'Logic Gate' },
  { name: 'Logic_gate-xor', sprite: 'Logic_gate-xor.webp', item: 'Logic Gate' },
  { name: 'Transistor_L', sprite: 'Transistor_L.webp', item: 'Transistor' },
  { name: 'Transistor_R', sprite: 'Transistor_R.webp', item: 'Transistor' },
  { name: 'Virtual_processor-cutter', sprite: 'Virtual_processor-cutter.webp', item: 'Virtual Processor' },
  { name: 'Virtual_processor-painter', sprite: 'Virtual_processor-painter.webp', item: 'Virtual Processor' },
  { name: 'Virtual_processor-rotater', sprite: 'Virtual_processor-rotater.webp', item: 'Virtual Processor' },
  { name: 'Virtual_processor-stacker', sprite: 'Virtual_processor-stacker.webp', item: 'Virtual Processor' },
  { name: 'Virtual_processor-unstacker', sprite: 'Virtual_processor-unstacker.webp', item: 'Virtual Processor' },
