...
[ ] Achievements: show hints importance (icon?) and text info
[ ] Text Client: Actual text client
[ ] Text Client: Real-Time hint display
[ ] Text Client: Better hint display and copying
[ ] Settings: Add Template managing (delete, reorder, export, import)
